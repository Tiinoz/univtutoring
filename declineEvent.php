...
if(isset($_POST["idEvent"])){
    ...
    $etu = $event->etudiant;
    // envoyer mail a l'étudiant
    $newEvent = new stdClass();
    $newEvent->id = $_POST["idEvent"];
    $newEvent->state = 1;
    univtutoring_send_mail($event->tuteur,$event->etudiant,"Rendez vous refusé", "Votre rendez-vous de tutorat le ".$event->start." a été REFUSE",$id);
    $newEvent->etudiant = null;
